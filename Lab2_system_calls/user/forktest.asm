...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <trace+0xa>
  ...
  68:	40c50513          	addi	a0,a0,1036 # 470 <trace+0x1a>
  ...
  b8:	40c50513          	addi	a0,a0,1036 # 4c0 <trace+0x6a>
  ...
  d4:	3c050513          	addi	a0,a0,960 # 490 <trace+0x3a>
  ...
  ee:	3be50513          	addi	a0,a0,958 # 4a8 <trace+0x52>
