...
main(int argc, char *argv[])
{
 ...
 106:	87e58593          	addi	a1,a1,-1922 # 980 <statistics+0xb8>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 496:	50e50513          	addi	a0,a0,1294 # 9a0 <digits>
 49a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a2:	2fa90913          	addi	s2,s2,762 # 998 <statistics+0xd0>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 8e2:	0da50513          	addi	a0,a0,218 # 9b8 <digits+0x18>
 8e6:	00000097          	auipc	ra,0x0
 8ea:	b08080e7          	jalr	-1272(ra) # 3ee <open>
  if(fd < 0) {
 ...
 908:	ac2080e7          	jalr	-1342(ra) # 3c6 <read>
 ...
 91c:	abe080e7          	jalr	-1346(ra) # 3d6 <close>
  return i;
}
 920:	8526                	mv	a0,s1
 ...
 936:	09658593          	addi	a1,a1,150 # 9c8 <digits+0x28>
 93a:	4509                	li	a0,2
 93c:	00000097          	auipc	ra,0x0
 940:	dbc080e7          	jalr	-580(ra) # 6f8 <fprintf>
      exit(1);
 944:	4505                	li	a0,1
 946:	00000097          	auipc	ra,0x0
 94a:	a68080e7          	jalr	-1432(ra) # 3ae <exit>
