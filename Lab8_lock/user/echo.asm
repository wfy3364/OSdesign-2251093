...
main(int argc, char *argv[])
{
  ...
  2e:	896a0a13          	addi	s4,s4,-1898 # 8c0 <statistics+0x92>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	86058593          	addi	a1,a1,-1952 # 8c8 <statistics+0x9a>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	4e050513          	addi	a0,a0,1248 # 8d8 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	414b8b93          	addi	s7,s7,1044 # 8d8 <digits>
 ...
 608:	2cc90913          	addi	s2,s2,716 # 8d0 <statistics+0xa2>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 834:	ec26                	sd	s1,24(sp)
 836:	e84a                	sd	s2,16(sp)
 838:	e44e                	sd	s3,8(sp)
 83a:	e052                	sd	s4,0(sp)
 83c:	1800                	addi	s0,sp,48
 83e:	8a2a                	mv	s4,a0
 840:	892e                	mv	s2,a1
  int fd, i, n;
 ...
 848:	0ac50513          	addi	a0,a0,172 # 8f0 <digits+0x18>
 84c:	00000097          	auipc	ra,0x0
 850:	b08080e7          	jalr	-1272(ra) # 354 <open>
  if(fd < 0) {
 854:	04054263          	bltz	a0,898 <statistics+0x6a>
 858:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 85a:	4481                	li	s1,0
 85c:	03205063          	blez	s2,87c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 860:	4099063b          	subw	a2,s2,s1
 864:	009a05b3          	add	a1,s4,s1
 868:	854e                	mv	a0,s3
 86a:	00000097          	auipc	ra,0x0
 86e:	ac2080e7          	jalr	-1342(ra) # 32c <read>
 872:	00054563          	bltz	a0,87c <statistics+0x4e>
      break;
    }
    i += n;
 876:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 878:	ff24c4e3          	blt	s1,s2,860 <statistics+0x32>
  }
  close(fd);
 87c:	854e                	mv	a0,s3
 87e:	00000097          	auipc	ra,0x0
 882:	abe080e7          	jalr	-1346(ra) # 33c <close>
  return i;
}
 886:	8526                	mv	a0,s1
 ...
 896:	8082                	ret
      fprintf(2, "stats: open failed\n");
 898:	00000597          	auipc	a1,0x0
 89c:	06858593          	addi	a1,a1,104 # 900 <digits+0x28>
 8a0:	4509                	li	a0,2
 8a2:	00000097          	auipc	ra,0x0
 8a6:	dbc080e7          	jalr	-580(ra) # 65e <fprintf>
      exit(1);
 8aa:	4505                	li	a0,1
 8ac:	00000097          	auipc	ra,0x0
 8b0:	a68080e7          	jalr	-1432(ra) # 314 <exit>
