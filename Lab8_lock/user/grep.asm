...
00000000000001ee <main>:
{
 ...
 262:	88258593          	addi	a1,a1,-1918 # ae0 <statistics+0x88>
 266:	4509                	li	a0,2
 ...
 298:	86c50513          	addi	a0,a0,-1940 # b00 <statistics+0xa8>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 626:	4fe50513          	addi	a0,a0,1278 # b20 <digits>
 62a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f2:	432b8b93          	addi	s7,s7,1074 # b20 <digits>
 ...
 832:	2ea90913          	addi	s2,s2,746 # b18 <statistics+0xc0>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 a72:	0ca50513          	addi	a0,a0,202 # b38 <digits+0x18>
 a76:	00000097          	auipc	ra,0x0
 a7a:	b08080e7          	jalr	-1272(ra) # 57e <open>
  if(fd < 0) {
 ...
 a98:	ac2080e7          	jalr	-1342(ra) # 556 <read>
 ...
 aac:	abe080e7          	jalr	-1346(ra) # 566 <close>
  return i;
}
 ab0:	8526                	mv	a0,s1
 ...
 ac6:	08658593          	addi	a1,a1,134 # b48 <digits+0x28>
 aca:	4509                	li	a0,2
 acc:	00000097          	auipc	ra,0x0
 ad0:	dbc080e7          	jalr	-580(ra) # 888 <fprintf>
      exit(1);
 ad4:	4505                	li	a0,1
 ad6:	00000097          	auipc	ra,0x0
 ada:	a68080e7          	jalr	-1432(ra) # 53e <exit>
