...
main(void)
{
  ...
  12:	93250513          	addi	a0,a0,-1742 # 940 <statistics+0x8a>
  ...
  3a:	92290913          	addi	s2,s2,-1758 # 958 <statistics+0xa2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	93e50513          	addi	a0,a0,-1730 # 9a8 <statistics+0xf2>
  ...
  8c:	8b850513          	addi	a0,a0,-1864 # 940 <statistics+0x8a>
  ...
  a0:	8ac50513          	addi	a0,a0,-1876 # 948 <statistics+0x92>
  a4:	00000097          	auipc	ra,0x0
  a8:	340080e7          	jalr	832(ra) # 3e4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	89250513          	addi	a0,a0,-1902 # 940 <statistics+0x8a>
  b6:	00000097          	auipc	ra,0x0
  ba:	326080e7          	jalr	806(ra) # 3dc <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	8b050513          	addi	a0,a0,-1872 # 970 <statistics+0xba>
  ...
  e6:	8a650513          	addi	a0,a0,-1882 # 988 <statistics+0xd2>
  ea:	00000097          	auipc	ra,0x0
  ee:	2ea080e7          	jalr	746(ra) # 3d4 <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	89e50513          	addi	a0,a0,-1890 # 990 <statistics+0xda>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 690:	33c90913          	addi	s2,s2,828 # 9c8 <statistics+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 758:	8bc7b783          	ld	a5,-1860(a5) # 1010 <freep>
 ...
 786:	00e6ea63          	bltu	a3,a4,79a <free+0x50>
{
 ...
 7c8:	84f73623          	sd	a5,-1972(a4) # 1010 <freep>
}
 7cc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fa:	81a53503          	ld	a0,-2022(a0) # 1010 <freep>
 ...
 822:	7f290913          	addi	s2,s2,2034 # 1010 <freep>
  if(p == (char*)-1)
 826:	5afd                	li	s5,-1
 828:	a88d                	j	89a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 82a:	00000797          	auipc	a5,0x0
 82e:	7f678793          	addi	a5,a5,2038 # 1020 <base>
...
statistics(void *buf, int sz)
{
 ...
 8d0:	07c50513          	addi	a0,a0,124 # 948 <statistics+0x92>
 8d4:	00000097          	auipc	ra,0x0
 8d8:	b08080e7          	jalr	-1272(ra) # 3dc <open>
  if(fd < 0) {
 8dc:	04054263          	bltz	a0,920 <statistics+0x6a>
 8e0:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8e2:	4481                	li	s1,0
 8e4:	03205063          	blez	s2,904 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8e8:	4099063b          	subw	a2,s2,s1
 8ec:	009a05b3          	add	a1,s4,s1
 8f0:	854e                	mv	a0,s3
 8f2:	00000097          	auipc	ra,0x0
 8f6:	ac2080e7          	jalr	-1342(ra) # 3b4 <read>
 8fa:	00054563          	bltz	a0,904 <statistics+0x4e>
      break;
    }
    i += n;
 8fe:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 900:	ff24c4e3          	blt	s1,s2,8e8 <statistics+0x32>
  }
  close(fd);
 904:	854e                	mv	a0,s3
 906:	00000097          	auipc	ra,0x0
 90a:	abe080e7          	jalr	-1346(ra) # 3c4 <close>
  return i;
}
 90e:	8526                	mv	a0,s1
 ...
 924:	0c858593          	addi	a1,a1,200 # 9e8 <digits+0x18>
 928:	4509                	li	a0,2
 92a:	00000097          	auipc	ra,0x0
 92e:	dbc080e7          	jalr	-580(ra) # 6e6 <fprintf>
      exit(1);
 932:	4505                	li	a0,1
 934:	00000097          	auipc	ra,0x0
 938:	a68080e7          	jalr	-1432(ra) # 39c <exit>
