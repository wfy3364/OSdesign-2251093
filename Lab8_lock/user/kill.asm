...
main(int argc, char **argv)
{
  ...
  4c:	85858593          	addi	a1,a1,-1960 # 8a0 <statistics+0x92>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3dc:	4e850513          	addi	a0,a0,1256 # 8c0 <digits>
 3e0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a8:	41cb8b93          	addi	s7,s7,1052 # 8c0 <digits>
 ...
 5e8:	2d490913          	addi	s2,s2,724 # 8b8 <statistics+0xaa>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 828:	0b450513          	addi	a0,a0,180 # 8d8 <digits+0x18>
 82c:	00000097          	auipc	ra,0x0
 830:	b08080e7          	jalr	-1272(ra) # 334 <open>
  if(fd < 0) {
 ...
 84e:	ac2080e7          	jalr	-1342(ra) # 30c <read>
 ...
 862:	abe080e7          	jalr	-1346(ra) # 31c <close>
  return i;
}
 866:	8526                	mv	a0,s1
 ...
 87c:	07058593          	addi	a1,a1,112 # 8e8 <digits+0x28>
 880:	4509                	li	a0,2
 882:	00000097          	auipc	ra,0x0
 886:	dbc080e7          	jalr	-580(ra) # 63e <fprintf>
      exit(1);
 88a:	4505                	li	a0,1
 88c:	00000097          	auipc	ra,0x0
 890:	a68080e7          	jalr	-1432(ra) # 2f4 <exit>
