...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <statistics+0x86>
  18:	4509                	li	a0,2
  ...
  50:	85c58593          	addi	a1,a1,-1956 # 8a8 <statistics+0x9e>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d8:	4f450513          	addi	a0,a0,1268 # 8c8 <digits>
 3dc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	428b8b93          	addi	s7,s7,1064 # 8c8 <digits>
 ...
 5e4:	2e090913          	addi	s2,s2,736 # 8c0 <statistics+0xb6>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 824:	0c050513          	addi	a0,a0,192 # 8e0 <digits+0x18>
 828:	00000097          	auipc	ra,0x0
 82c:	b08080e7          	jalr	-1272(ra) # 330 <open>
  if(fd < 0) {
 ...
 84a:	ac2080e7          	jalr	-1342(ra) # 308 <read>
 ...
 85e:	abe080e7          	jalr	-1346(ra) # 318 <close>
  return i;
}
 862:	8526                	mv	a0,s1
 ...
 878:	07c58593          	addi	a1,a1,124 # 8f0 <digits+0x28>
 87c:	4509                	li	a0,2
 87e:	00000097          	auipc	ra,0x0
 882:	dbc080e7          	jalr	-580(ra) # 63a <fprintf>
      exit(1);
 886:	4505                	li	a0,1
 888:	00000097          	auipc	ra,0x0
 88c:	a68080e7          	jalr	-1432(ra) # 2f0 <exit>
