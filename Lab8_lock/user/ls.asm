...
ls(char *path)
{
 ...
 12c:	a1850513          	addi	a0,a0,-1512 # b40 <statistics+0xbe>
 ...
 16a:	9aa58593          	addi	a1,a1,-1622 # b10 <statistics+0x8e>
 16e:	4509                	li	a0,2
 ...
 180:	9ac58593          	addi	a1,a1,-1620 # b28 <statistics+0xa6>
 184:	4509                	li	a0,2
 ...
 1b2:	9a250513          	addi	a0,a0,-1630 # b50 <statistics+0xce>
 ...
 1f8:	974a0a13          	addi	s4,s4,-1676 # b68 <statistics+0xe6>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	92ca8a93          	addi	s5,s5,-1748 # b28 <statistics+0xa6>
...
main(int argc, char *argv[])
{
 ...
 2c2:	8ba50513          	addi	a0,a0,-1862 # b78 <statistics+0xf6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 650:	53c50513          	addi	a0,a0,1340 # b88 <digits>
 654:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 71c:	470b8b93          	addi	s7,s7,1136 # b88 <digits>
 ...
 85c:	32890913          	addi	s2,s2,808 # b80 <statistics+0xfe>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 a9c:	10850513          	addi	a0,a0,264 # ba0 <digits+0x18>
 aa0:	00000097          	auipc	ra,0x0
 aa4:	b08080e7          	jalr	-1272(ra) # 5a8 <open>
  if(fd < 0) {
 aa8:	04054263          	bltz	a0,aec <statistics+0x6a>
 aac:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 aae:	4481                	li	s1,0
 ab0:	03205063          	blez	s2,ad0 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 ab4:	4099063b          	subw	a2,s2,s1
 ab8:	009a05b3          	add	a1,s4,s1
 abc:	854e                	mv	a0,s3
 abe:	00000097          	auipc	ra,0x0
 ac2:	ac2080e7          	jalr	-1342(ra) # 580 <read>
 ac6:	00054563          	bltz	a0,ad0 <statistics+0x4e>
      break;
    }
    i += n;
 aca:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 acc:	ff24c4e3          	blt	s1,s2,ab4 <statistics+0x32>
  }
  close(fd);
 ad0:	854e                	mv	a0,s3
 ad2:	00000097          	auipc	ra,0x0
 ad6:	abe080e7          	jalr	-1346(ra) # 590 <close>
  return i;
}
 ada:	8526                	mv	a0,s1
 adc:	70a2                	ld	ra,40(sp)
 ade:	7402                	ld	s0,32(sp)
 ae0:	64e2                	ld	s1,24(sp)
 ae2:	6942                	ld	s2,16(sp)
 ae4:	69a2                	ld	s3,8(sp)
 ae6:	6a02                	ld	s4,0(sp)
 ...
 af0:	0c458593          	addi	a1,a1,196 # bb0 <digits+0x28>
 af4:	4509                	li	a0,2
 af6:	00000097          	auipc	ra,0x0
 afa:	dbc080e7          	jalr	-580(ra) # 8b2 <fprintf>
      exit(1);
 afe:	4505                	li	a0,1
 b00:	00000097          	auipc	ra,0x0
 b04:	a68080e7          	jalr	-1432(ra) # 568 <exit>
