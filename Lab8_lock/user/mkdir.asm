...
main(int argc, char *argv[])
{
  ...
  42:	87258593          	addi	a1,a1,-1934 # 8b0 <statistics+0x8e>
  46:	4509                	li	a0,2
  ...
  60:	86c58593          	addi	a1,a1,-1940 # 8c8 <statistics+0xa6>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	50450513          	addi	a0,a0,1284 # 8f0 <digits>
 3f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	438b8b93          	addi	s7,s7,1080 # 8f0 <digits>
 ...
 5fc:	2f090913          	addi	s2,s2,752 # 8e8 <statistics+0xc6>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 83c:	0d050513          	addi	a0,a0,208 # 908 <digits+0x18>
 840:	00000097          	auipc	ra,0x0
 844:	b08080e7          	jalr	-1272(ra) # 348 <open>
  if(fd < 0) {
 ...
 862:	ac2080e7          	jalr	-1342(ra) # 320 <read>
 ...
 876:	abe080e7          	jalr	-1346(ra) # 330 <close>
  return i;
}
 87a:	8526                	mv	a0,s1
 ...
 890:	08c58593          	addi	a1,a1,140 # 918 <digits+0x28>
 894:	4509                	li	a0,2
 896:	00000097          	auipc	ra,0x0
 89a:	dbc080e7          	jalr	-580(ra) # 652 <fprintf>
      exit(1);
 89e:	4505                	li	a0,1
 8a0:	00000097          	auipc	ra,0x0
 8a4:	a68080e7          	jalr	-1432(ra) # 308 <exit>
