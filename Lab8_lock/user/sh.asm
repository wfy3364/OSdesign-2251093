...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	37e58593          	addi	a1,a1,894 # 1390 <statistics+0x90>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	33858593          	addi	a1,a1,824 # 1398 <statistics+0x98>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	30650513          	addi	a0,a0,774 # 13a0 <statistics+0xa0>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3da70713          	addi	a4,a4,986 # 14a0 <statistics+0x1a0>
    ...
    panic("runcmd");
      ...
      e4:	2c850513          	addi	a0,a0,712 # 13a8 <statistics+0xa8>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2ae58593          	addi	a1,a1,686 # 13b0 <statistics+0xb0>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	27258593          	addi	a1,a1,626 # 13c0 <statistics+0xc0>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	1ec50513          	addi	a0,a0,492 # 13d0 <statistics+0xd0>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	e54b8b93          	addi	s7,s7,-428 # 13f8 <statistics+0xf8>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	e2250513          	addi	a0,a0,-478 # 13d8 <statistics+0xd8>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d6260613          	addi	a2,a2,-670 # 1400 <statistics+0x100>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	d52b0b13          	addi	s6,s6,-686 # 1420 <statistics+0x120>
  ...
  return ret;
     ...
     70c:	d0050513          	addi	a0,a0,-768 # 1408 <statistics+0x108>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	ca650513          	addi	a0,a0,-858 # 1410 <statistics+0x110>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	c8460613          	addi	a2,a2,-892 # 1428 <statistics+0x128>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	c1ca0a13          	addi	s4,s4,-996 # 1430 <statistics+0x130>
     81c:	8652                	mv	a2,s4
     81e:	85ce                	mv	a1,s3
     820:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	bee60613          	addi	a2,a2,-1042 # 1438 <statistics+0x138>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	b5060613          	addi	a2,a2,-1200 # 1400 <statistics+0x100>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	b7060613          	addi	a2,a2,-1168 # 1450 <statistics+0x150>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	b1e50513          	addi	a0,a0,-1250 # 1440 <statistics+0x140>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	b2650513          	addi	a0,a0,-1242 # 1458 <statistics+0x158>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	b5a70713          	addi	a4,a4,-1190 # 14b8 <statistics+0x1b8>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	a6660613          	addi	a2,a2,-1434 # 1470 <statistics+0x170>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	a3858593          	addi	a1,a1,-1480 # 1478 <statistics+0x178>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6e6080e7          	jalr	1766(ra) # 1130 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	9b650513          	addi	a0,a0,-1610 # 1408 <statistics+0x108>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	a1448493          	addi	s1,s1,-1516 # 1488 <statistics+0x188>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	9dea8a93          	addi	s5,s5,-1570 # 1490 <statistics+0x190>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ece:	60e50513          	addi	a0,a0,1550 # 14d8 <digits>
     ed2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f9a:	542b8b93          	addi	s7,s7,1346 # 14d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10da:	3fa90913          	addi	s2,s2,1018 # 14d0 <statistics+0x1d0>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
  ...
  fd = open("statistics", O_RDONLY);
    ...
    131a:	1da50513          	addi	a0,a0,474 # 14f0 <digits+0x18>
    131e:	00000097          	auipc	ra,0x0
    1322:	b08080e7          	jalr	-1272(ra) # e26 <open>
  if(fd < 0) {
  ...
  for (i = 0; i < sz; ) {
    ...
    1340:	ac2080e7          	jalr	-1342(ra) # dfe <read>
  ...
  close(fd);
    ...
    1354:	abe080e7          	jalr	-1346(ra) # e0e <close>
  return i;
}
    1358:	8526                	mv	a0,s1
    ...
    136e:	19658593          	addi	a1,a1,406 # 1500 <digits+0x28>
    1372:	4509                	li	a0,2
    1374:	00000097          	auipc	ra,0x0
    1378:	dbc080e7          	jalr	-580(ra) # 1130 <fprintf>
      exit(1);
    137c:	4505                	li	a0,1
    137e:	00000097          	auipc	ra,0x0
    1382:	a68080e7          	jalr	-1432(ra) # de6 <exit>
