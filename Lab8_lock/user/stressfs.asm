...
main(int argc, char *argv[])
{
  ...
  1a:	95a78793          	addi	a5,a5,-1702 # 970 <statistics+0xba>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91450513          	addi	a0,a0,-1772 # 940 <statistics+0x8a>
  ...
  6c:	8f050513          	addi	a0,a0,-1808 # 958 <statistics+0xa2>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8b250513          	addi	a0,a0,-1870 # 968 <statistics+0xb2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 484:	50850513          	addi	a0,a0,1288 # 988 <digits>
 488:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 550:	43cb8b93          	addi	s7,s7,1084 # 988 <digits>
 ...
 690:	2f490913          	addi	s2,s2,756 # 980 <statistics+0xca>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 8d0:	0d450513          	addi	a0,a0,212 # 9a0 <digits+0x18>
 ...
 924:	09058593          	addi	a1,a1,144 # 9b0 <digits+0x28>
 928:	4509                	li	a0,2
