...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	18250513          	addi	a0,a0,386 # 61c0 <statistics+0xa8>
      ...
      74:	8082                	ret
{
      ...
      84:	16050513          	addi	a0,a0,352 # 61e0 <statistics+0xc8>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	15050513          	addi	a0,a0,336 # 61f8 <statistics+0xe0>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	15250513          	addi	a0,a0,338 # 6218 <statistics+0x100>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	11a50513          	addi	a0,a0,282 # 6200 <statistics+0xe8>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	12650513          	addi	a0,a0,294 # 6228 <statistics+0x110>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	12450513          	addi	a0,a0,292 # 6250 <statistics+0x138>
     134:	00006097          	auipc	ra,0x6
     138:	b1a080e7          	jalr	-1254(ra) # 5c4e <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	11050513          	addi	a0,a0,272 # 6250 <statistics+0x138>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	10c58593          	addi	a1,a1,268 # 6260 <statistics+0x148>
     15c:	00006097          	auipc	ra,0x6
     160:	ac2080e7          	jalr	-1342(ra) # 5c1e <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	0e850513          	addi	a0,a0,232 # 6250 <statistics+0x138>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	0ec58593          	addi	a1,a1,236 # 6268 <statistics+0x150>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	0bc50513          	addi	a0,a0,188 # 6250 <statistics+0x138>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	0a650513          	addi	a0,a0,166 # 6270 <statistics+0x158>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	01c50513          	addi	a0,a0,28 # 6298 <statistics+0x180>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	008a8a93          	addi	s5,s5,8 # 6298 <statistics+0x180>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f9650513          	addi	a0,a0,-106 # 62a8 <statistics+0x190>
     ...
     33a:	f9250513          	addi	a0,a0,-110 # 62c8 <statistics+0x1b0>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	f8050513          	addi	a0,a0,-128 # 62e0 <statistics+0x1c8>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	f6c98993          	addi	s3,s3,-148 # 62e0 <statistics+0x1c8>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	f2050513          	addi	a0,a0,-224 # 62e0 <statistics+0x1c8>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	e9058593          	addi	a1,a1,-368 # 6268 <statistics+0x150>
    ...
    printf("write failed\n");
     ...
     3f2:	f1250513          	addi	a0,a0,-238 # 6300 <statistics+0x1e8>
    ...
    exit(1);
     ...
     40c:	ee050513          	addi	a0,a0,-288 # 62e8 <statistics+0x1d0>
    ...
    printf("open junk failed\n");
     ...
     426:	ec650513          	addi	a0,a0,-314 # 62e8 <statistics+0x1d0>
  ...
  unlink("junk");
     ...
     44a:	e9a50513          	addi	a0,a0,-358 # 62e0 <statistics+0x1c8>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	dbea0a13          	addi	s4,s4,-578 # 6310 <statistics+0x1f8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	d1a50513          	addi	a0,a0,-742 # 6318 <statistics+0x200>
     ...
     620:	d1450513          	addi	a0,a0,-748 # 6330 <statistics+0x218>
     ...
     63e:	d2650513          	addi	a0,a0,-730 # 6360 <statistics+0x248>
     ...
     658:	d3c50513          	addi	a0,a0,-708 # 6390 <statistics+0x278>
     ...
     676:	d2e50513          	addi	a0,a0,-722 # 63a0 <statistics+0x288>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6be:	d16a0a13          	addi	s4,s4,-746 # 63d0 <statistics+0x2b8>
    n = write(fds[1], "x", 1);
     6c2:	00006a97          	auipc	s5,0x6
     6c6:	ba6a8a93          	addi	s5,s5,-1114 # 6268 <statistics+0x150>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     76a:	c7250513          	addi	a0,a0,-910 # 63d8 <statistics+0x2c0>
     ...
     788:	c6c50513          	addi	a0,a0,-916 # 63f0 <statistics+0x2d8>
     ...
     7a2:	bf250513          	addi	a0,a0,-1038 # 6390 <statistics+0x278>
     ...
     7bc:	c6850513          	addi	a0,a0,-920 # 6420 <statistics+0x308>
     ...
     7da:	c6250513          	addi	a0,a0,-926 # 6438 <statistics+0x320>
...
00000000000007f0 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     830:	a3458593          	addi	a1,a1,-1484 # 6260 <statistics+0x148>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     84c:	a0850513          	addi	a0,a0,-1528 # 6250 <statistics+0x138>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     878:	9dc50513          	addi	a0,a0,-1572 # 6250 <statistics+0x138>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     88c:	9c850513          	addi	a0,a0,-1592 # 6250 <statistics+0x138>
  ...
  write(fd1, "abcdef", 6);
     ...
     8ca:	c0258593          	addi	a1,a1,-1022 # 64c8 <statistics+0x3b0>
     8ce:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     90c:	94850513          	addi	a0,a0,-1720 # 6250 <statistics+0x138>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     950:	b1c50513          	addi	a0,a0,-1252 # 6468 <statistics+0x350>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     96c:	b2050513          	addi	a0,a0,-1248 # 6488 <statistics+0x370>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     980:	b1c50513          	addi	a0,a0,-1252 # 6498 <statistics+0x380>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     99c:	b2050513          	addi	a0,a0,-1248 # 64b8 <statistics+0x3a0>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9b0:	aec50513          	addi	a0,a0,-1300 # 6498 <statistics+0x380>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9ce:	b0650513          	addi	a0,a0,-1274 # 64d0 <statistics+0x3b8>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9ec:	b0850513          	addi	a0,a0,-1272 # 64f0 <statistics+0x3d8>
...
0000000000000a02 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a20:	af450513          	addi	a0,a0,-1292 # 6510 <statistics+0x3f8>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a38:	b0498993          	addi	s3,s3,-1276 # 6538 <statistics+0x420>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a3c:	00006a97          	auipc	s5,0x6
     a40:	b34a8a93          	addi	s5,s5,-1228 # 6570 <statistics+0x458>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a86:	a8e50513          	addi	a0,a0,-1394 # 6510 <statistics+0x3f8>
  ...
  if(unlink("small") < 0){
     ...
     ac2:	a5250513          	addi	a0,a0,-1454 # 6510 <statistics+0x3f8>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     aec:	a3050513          	addi	a0,a0,-1488 # 6518 <statistics+0x400>
    ...
    exit(1);
     ...
     b0a:	a4250513          	addi	a0,a0,-1470 # 6548 <statistics+0x430>
     ...
     b28:	a5c50513          	addi	a0,a0,-1444 # 6580 <statistics+0x468>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b44:	a6850513          	addi	a0,a0,-1432 # 65a8 <statistics+0x490>
    ...
    printf("%s: read failed\n", s);
     ...
     b60:	a6c50513          	addi	a0,a0,-1428 # 65c8 <statistics+0x4b0>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b7c:	a6850513          	addi	a0,a0,-1432 # 65e0 <statistics+0x4c8>
...
0000000000000b92 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     bae:	a5650513          	addi	a0,a0,-1450 # 6600 <statistics+0x4e8>
  ...
  fd = open("big", O_RDONLY);
     ...
     c00:	a0450513          	addi	a0,a0,-1532 # 6600 <statistics+0x4e8>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c48:	9c450513          	addi	a0,a0,-1596 # 6608 <statistics+0x4f0>
    ...
    exit(1);
     ...
     c66:	9c650513          	addi	a0,a0,-1594 # 6628 <statistics+0x510>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c82:	9d250513          	addi	a0,a0,-1582 # 6650 <statistics+0x538>
  ...
  if(unlink("big") < 0){
     ...
     cae:	95650513          	addi	a0,a0,-1706 # 6600 <statistics+0x4e8>
     ...
     cda:	99a50513          	addi	a0,a0,-1638 # 6670 <statistics+0x558>
     ...
     cf8:	9a450513          	addi	a0,a0,-1628 # 6698 <statistics+0x580>
     ...
     d16:	99e50513          	addi	a0,a0,-1634 # 66b0 <statistics+0x598>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d32:	9aa50513          	addi	a0,a0,-1622 # 66d8 <statistics+0x5c0>
...
0000000000000d48 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d60:	99450513          	addi	a0,a0,-1644 # 66f0 <statistics+0x5d8>
  ...
  write(fd, "hello", SZ);
     ...
     d78:	9ac58593          	addi	a1,a1,-1620 # 6720 <statistics+0x608>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d94:	96050513          	addi	a0,a0,-1696 # 66f0 <statistics+0x5d8>
  ...
  if(unlink("unlinkread") != 0){
     ...
     daa:	94a50513          	addi	a0,a0,-1718 # 66f0 <statistics+0x5d8>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dc0:	93450513          	addi	a0,a0,-1740 # 66f0 <statistics+0x5d8>
  ...
  write(fd1, "yyy", 3);
     ...
     dd4:	99858593          	addi	a1,a1,-1640 # 6768 <statistics+0x650>
  ...
  unlink("unlinkread");
     ...
     e3c:	8b850513          	addi	a0,a0,-1864 # 66f0 <statistics+0x5d8>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e5c:	8a850513          	addi	a0,a0,-1880 # 6700 <statistics+0x5e8>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e78:	8b450513          	addi	a0,a0,-1868 # 6728 <statistics+0x610>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e94:	8b850513          	addi	a0,a0,-1864 # 6748 <statistics+0x630>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     eb0:	8c450513          	addi	a0,a0,-1852 # 6770 <statistics+0x658>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ecc:	8c850513          	addi	a0,a0,-1848 # 6790 <statistics+0x678>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee8:	8cc50513          	addi	a0,a0,-1844 # 67b0 <statistics+0x698>
...
0000000000000efe <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f4c:	7d858593          	addi	a1,a1,2008 # 6720 <statistics+0x608>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f6c:	87058593          	addi	a1,a1,-1936 # 67d8 <statistics+0x6c0>
     f70:	00006517          	auipc	a0,0x6
     f74:	86050513          	addi	a0,a0,-1952 # 67d0 <statistics+0x6b8>
  ...
  unlink("lf1");
     ...
     f88:	84c50513          	addi	a0,a0,-1972 # 67d0 <statistics+0x6b8>
     f8c:	00005097          	auipc	ra,0x5
     f90:	cc2080e7          	jalr	-830(ra) # 5c4e <unlink>
  if(open("lf1", 0) >= 0){
     f94:	4581                	li	a1,0
     f96:	00006517          	auipc	a0,0x6
     f9a:	83a50513          	addi	a0,a0,-1990 # 67d0 <statistics+0x6b8>
  ...
  fd = open("lf2", 0);
     ...
     fb0:	82c50513          	addi	a0,a0,-2004 # 67d8 <statistics+0x6c0>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe8:	7f458593          	addi	a1,a1,2036 # 67d8 <statistics+0x6c0>
     fec:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ffe:	7de50513          	addi	a0,a0,2014 # 67d8 <statistics+0x6c0>
    1002:	00005097          	auipc	ra,0x5
    1006:	c4c080e7          	jalr	-948(ra) # 5c4e <unlink>
  if(link("lf2", "lf1") >= 0){
    100a:	00005597          	auipc	a1,0x5
    100e:	7c658593          	addi	a1,a1,1990 # 67d0 <statistics+0x6b8>
    1012:	00005517          	auipc	a0,0x5
    1016:	7c650513          	addi	a0,a0,1990 # 67d8 <statistics+0x6c0>
  ...
  if(link(".", "lf1") >= 0){
    ...
    102a:	7aa58593          	addi	a1,a1,1962 # 67d0 <statistics+0x6b8>
    102e:	00006517          	auipc	a0,0x6
    1032:	8b250513          	addi	a0,a0,-1870 # 68e0 <statistics+0x7c8>
    ...
    1054:	79050513          	addi	a0,a0,1936 # 67e0 <statistics+0x6c8>
    ...
    1070:	78c50513          	addi	a0,a0,1932 # 67f8 <statistics+0x6e0>
    ...
    108c:	78850513          	addi	a0,a0,1928 # 6810 <statistics+0x6f8>
    ...
    10a8:	78c50513          	addi	a0,a0,1932 # 6830 <statistics+0x718>
    ...
    10c4:	7a050513          	addi	a0,a0,1952 # 6860 <statistics+0x748>
    ...
    10e0:	79c50513          	addi	a0,a0,1948 # 6878 <statistics+0x760>
    ...
    10fc:	79850513          	addi	a0,a0,1944 # 6890 <statistics+0x778>
    ...
    1118:	7a450513          	addi	a0,a0,1956 # 68b8 <statistics+0x7a0>
    ...
    1134:	7b850513          	addi	a0,a0,1976 # 68e8 <statistics+0x7d0>
...
000000000000114a <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1166:	7a698993          	addi	s3,s3,1958 # 6908 <statistics+0x7f0>
    116a:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    11a2:	77a50513          	addi	a0,a0,1914 # 6918 <statistics+0x800>
...
00000000000011b8 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1208:	734a0a13          	addi	s4,s4,1844 # 6938 <statistics+0x820>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    125a:	6e250513          	addi	a0,a0,1762 # 6938 <statistics+0x820>
  ...
  for(i = 0; i < N; i++){
    ...
    12ca:	67a50513          	addi	a0,a0,1658 # 6940 <statistics+0x828>
    ...
    12ea:	67a50513          	addi	a0,a0,1658 # 6960 <statistics+0x848>
    ...
    1306:	67e50513          	addi	a0,a0,1662 # 6980 <statistics+0x868>
...
0000000000001354 <badarg>:
{
    ...
    1372:	e8a98993          	addi	s3,s3,-374 # 61f8 <statistics+0xe0>
    argv[0] = (char*)0xffffffff;
...
000000000000139a <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13fc:	7e078793          	addi	a5,a5,2016 # 7bd8 <statistics+0x1ac0>
  ...
  if(pid == 0){
    ...
    1432:	13278793          	addi	a5,a5,306 # 9560 <big.1272>
    1436:	00009697          	auipc	a3,0x9
    143a:	12a68693          	addi	a3,a3,298 # a560 <big.1272+0x1000>
      big[i] = 'x';
    ...
    1450:	10078a23          	sb	zero,276(a5) # a560 <big.1272+0x1000>
    char *args2[] = { big, big, big, 0 };
    1454:	00007797          	auipc	a5,0x7
    1458:	1a478793          	addi	a5,a5,420 # 85f8 <statistics+0x24e0>
    ...
    147c:	d8050513          	addi	a0,a0,-640 # 61f8 <statistics+0xe0>
    ...
    1494:	59850513          	addi	a0,a0,1432 # 6a28 <statistics+0x910>
    ...
    14b4:	4f050513          	addi	a0,a0,1264 # 69a0 <statistics+0x888>
    ...
    14d4:	4f050513          	addi	a0,a0,1264 # 69c0 <statistics+0x8a8>
    ...
    14f6:	4ee50513          	addi	a0,a0,1262 # 69e0 <statistics+0x8c8>
    ...
    1516:	4f650513          	addi	a0,a0,1270 # 6a08 <statistics+0x8f0>
    ...
    1530:	95c50513          	addi	a0,a0,-1700 # 6e88 <statistics+0xd70>
  ...
  if(st != 747){
    ...
    157a:	4da50513          	addi	a0,a0,1242 # 6a50 <statistics+0x938>
...
0000000000001590 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15ac:	ca850513          	addi	a0,a0,-856 # 6250 <statistics+0x138>
  ...
  if(pid == 0){
    ...
    15d6:	c7ea0a13          	addi	s4,s4,-898 # 6250 <statistics+0x138>
      int n = write(fd, "1234567890", 10);
    15da:	00005a97          	auipc	s5,0x5
    15de:	4d6a8a93          	addi	s5,s5,1238 # 6ab0 <statistics+0x998>
      int fd = open("truncfile", O_WRONLY);
    15e2:	4585                	li	a1,1
    15e4:	8552                	mv	a0,s4
    ...
    164e:	43650513          	addi	a0,a0,1078 # 6a80 <statistics+0x968>
    ...
    166a:	43250513          	addi	a0,a0,1074 # 6a98 <statistics+0x980>
    ...
    1688:	43c50513          	addi	a0,a0,1084 # 6ac0 <statistics+0x9a8>
    ...
    16a6:	baea0a13          	addi	s4,s4,-1106 # 6250 <statistics+0x138>
    int n = write(fd, "xxx", 3);
    16aa:	00005a97          	auipc	s5,0x5
    16ae:	436a8a93          	addi	s5,s5,1078 # 6ae0 <statistics+0x9c8>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f8:	b5c50513          	addi	a0,a0,-1188 # 6250 <statistics+0x138>
  ...
  exit(xstatus);
    ...
    1716:	38650513          	addi	a0,a0,902 # 6a98 <statistics+0x980>
    ...
    1734:	3b850513          	addi	a0,a0,952 # 6ae8 <statistics+0x9d0>
...
000000000000174a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    175c:	aa078793          	addi	a5,a5,-1376 # 61f8 <statistics+0xe0>
    1760:	fcf43023          	sd	a5,-64(s0)
    1764:	00005797          	auipc	a5,0x5
    1768:	3a478793          	addi	a5,a5,932 # 6b08 <statistics+0x9f0>
    176c:	fcf43423          	sd	a5,-56(s0)
    1770:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1774:	00005517          	auipc	a0,0x5
    1778:	39c50513          	addi	a0,a0,924 # 6b10 <statistics+0x9f8>
  ...
  if(pid == 0) {
    ...
    17a6:	36e50513          	addi	a0,a0,878 # 6b10 <statistics+0x9f8>
    ...
    17c2:	37250513          	addi	a0,a0,882 # 6b30 <statistics+0xa18>
    ...
    17de:	2a650513          	addi	a0,a0,678 # 6a80 <statistics+0x968>
    ...
    17fa:	32250513          	addi	a0,a0,802 # 6b18 <statistics+0xa00>
    ...
    1818:	9e450513          	addi	a0,a0,-1564 # 61f8 <statistics+0xe0>
  ...
  if(xstatus != 0)
    ...
    184c:	2f850513          	addi	a0,a0,760 # 6b40 <statistics+0xa28>
    ...
    1868:	2f450513          	addi	a0,a0,756 # 6b58 <statistics+0xa40>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    187c:	29850513          	addi	a0,a0,664 # 6b10 <statistics+0x9f8>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18a6:	d2650513          	addi	a0,a0,-730 # 65c8 <statistics+0x4b0>
    ...
    18c2:	1da50513          	addi	a0,a0,474 # 6a98 <statistics+0x980>
  ...
  unlink("echo-ok");
    ...
    18dc:	23850513          	addi	a0,a0,568 # 6b10 <statistics+0x9f8>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1906:	26e50513          	addi	a0,a0,622 # 6b70 <statistics+0xa58>
...
0000000000001926 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c8:	1c450513          	addi	a0,a0,452 # 6b88 <statistics+0xa70>
    ...
    1a02:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x93>
{
    ...
    1a4e:	15650513          	addi	a0,a0,342 # 6ba0 <statistics+0xa88>
    ...
    1a6a:	15250513          	addi	a0,a0,338 # 6bb8 <statistics+0xaa0>
    ...
    1a9c:	13850513          	addi	a0,a0,312 # 6bd0 <statistics+0xab8>
    ...
    1adc:	11850513          	addi	a0,a0,280 # 6bf0 <statistics+0xad8>
...
0000000000001af2 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b4e:	f3650513          	addi	a0,a0,-202 # 6a80 <statistics+0x968>
    ...
    1b6a:	0a250513          	addi	a0,a0,162 # 6c08 <statistics+0xaf0>
    ...
    1b86:	09e50513          	addi	a0,a0,158 # 6c20 <statistics+0xb08>
...
0000000000001ba6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bfe:	e8650513          	addi	a0,a0,-378 # 6a80 <statistics+0x968>
    ...
    1c22:	e6250513          	addi	a0,a0,-414 # 6a80 <statistics+0x968>
...
0000000000001c40 <forkfork>:
{
    ...
    1c9c:	fa850513          	addi	a0,a0,-88 # 6c40 <statistics+0xb28>
    ...
    1cae:	f54080e7          	jalr	-172(ra) # 5bfe <exit>
{
    ...
    1cf4:	f6050513          	addi	a0,a0,-160 # 6c50 <statistics+0xb38>
...
0000000000001d0a <reparent2>:
{
  ...
  exit(0);
    ...
    1d42:	14a50513          	addi	a0,a0,330 # 6e88 <statistics+0xd70>
...
0000000000001d72 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1de0:	0ac50513          	addi	a0,a0,172 # 6e88 <statistics+0xd70>
    ...
    1e0c:	d1050513          	addi	a0,a0,-752 # 6b18 <statistics+0xa00>
    ...
    1e7e:	df650513          	addi	a0,a0,-522 # 6c70 <statistics+0xb58>
    ...
    1eb2:	dda50513          	addi	a0,a0,-550 # 6c88 <statistics+0xb70>
    ...
    1f18:	d9c50513          	addi	a0,a0,-612 # 6cb0 <statistics+0xb98>
...
0000000000001f98 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb8:	2b450513          	addi	a0,a0,692 # 6268 <statistics+0x150>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ff4:	278a8a93          	addi	s5,s5,632 # 6268 <statistics+0x150>
      link("cat", "x");
    1ff8:	00005b97          	auipc	s7,0x5
    1ffc:	ce0b8b93          	addi	s7,s7,-800 # 6cd8 <statistics+0xbc0>
    2000:	a091                	j	2044 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    2002:	85a6                	mv	a1,s1
    2004:	00005517          	auipc	a0,0x5
    2008:	a7c50513          	addi	a0,a0,-1412 # 6a80 <statistics+0x968>
...
000000000000209a <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ca:	c3250513          	addi	a0,a0,-974 # 6cf8 <statistics+0xbe0>
  ...
  if(wait(0) != -1){
    ...
    212c:	bb850513          	addi	a0,a0,-1096 # 6ce0 <statistics+0xbc8>
    ...
    2148:	bdc50513          	addi	a0,a0,-1060 # 6d20 <statistics+0xc08>
    ...
    2164:	bd850513          	addi	a0,a0,-1064 # 6d38 <statistics+0xc20>
...
000000000000217a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21e4:	8a050513          	addi	a0,a0,-1888 # 6a80 <statistics+0x968>
    ...
    2206:	b4e50513          	addi	a0,a0,-1202 # 6d50 <statistics+0xc38>
...
0000000000002226 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2288:	7fc50513          	addi	a0,a0,2044 # 6a80 <statistics+0x968>
    ...
    22b4:	ac050513          	addi	a0,a0,-1344 # 6d70 <statistics+0xc58>
...
00000000000022d4 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22e4:	aa850513          	addi	a0,a0,-1368 # 6d88 <statistics+0xc70>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2316:	a7650513          	addi	a0,a0,-1418 # 6d88 <statistics+0xc70>
  ...
  close(fd);
    ...
    233c:	12878793          	addi	a5,a5,296 # 9460 <args.1820>
    2340:	00007697          	auipc	a3,0x7
    2344:	21868693          	addi	a3,a3,536 # 9558 <args.1820+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2348:	00005717          	auipc	a4,0x5
    234c:	a5070713          	addi	a4,a4,-1456 # 6d98 <statistics+0xc80>
    ...
    23a0:	adc50513          	addi	a0,a0,-1316 # 6e78 <statistics+0xd60>
    ...
    23c4:	ad850513          	addi	a0,a0,-1320 # 6e98 <statistics+0xd80>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2422:	a9a50513          	addi	a0,a0,-1382 # 6eb8 <statistics+0xda0>
    ...
    243e:	64650513          	addi	a0,a0,1606 # 6a80 <statistics+0x968>
...
000000000000245e <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24ac:	5d850513          	addi	a0,a0,1496 # 6a80 <statistics+0x968>
...
00000000000024cc <manywrites>:
{
  ...
  exit(0);
    ...
    2528:	96450513          	addi	a0,a0,-1692 # 6e88 <statistics+0xd70>
    ...
    25d8:	90c50513          	addi	a0,a0,-1780 # 6ee0 <statistics+0xdc8>
    ...
    25f8:	cd450513          	addi	a0,a0,-812 # 62c8 <statistics+0x1b0>
...
0000000000002616 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2690:	54c78793          	addi	a5,a5,1356 # 7bd8 <statistics+0x1ac0>
  ...
  if(ret != -1){
    ...
    26d2:	82a50513          	addi	a0,a0,-2006 # 6ef8 <statistics+0xde0>
    ...
    26f0:	2b450513          	addi	a0,a0,692 # 69a0 <statistics+0x888>
    ...
    270e:	2b650513          	addi	a0,a0,694 # 69c0 <statistics+0x8a8>
    ...
    272e:	2b650513          	addi	a0,a0,694 # 69e0 <statistics+0x8c8>
    ...
    274c:	2c050513          	addi	a0,a0,704 # 6a08 <statistics+0x8f0>
...
0000000000002762 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2798:	7a450513          	addi	a0,a0,1956 # 6f38 <statistics+0xe20>
  ...
  if(n >= 0){
    ...
    27ca:	79250513          	addi	a0,a0,1938 # 6f58 <statistics+0xe40>
    ...
    27e4:	72050513          	addi	a0,a0,1824 # 6f00 <statistics+0xde8>
    ...
    27fe:	71e50513          	addi	a0,a0,1822 # 6f18 <statistics+0xe00>
    ...
    2818:	72c50513          	addi	a0,a0,1836 # 6f40 <statistics+0xe28>
  ...
  unlink("rwsbrk");
    ...
    283c:	70050513          	addi	a0,a0,1792 # 6f38 <statistics+0xe20>
    2840:	00003097          	auipc	ra,0x3
    2844:	40e080e7          	jalr	1038(ra) # 5c4e <unlink>
  fd = open("README", O_RDONLY);
    2848:	4581                	li	a1,0
    284a:	00004517          	auipc	a0,0x4
    284e:	b8650513          	addi	a0,a0,-1146 # 63d0 <statistics+0x2b8>
  ...
  if(n >= 0){
    ...
    2878:	71450513          	addi	a0,a0,1812 # 6f88 <statistics+0xe70>
    ...
    2892:	6b250513          	addi	a0,a0,1714 # 6f40 <statistics+0xe28>
...
00000000000028bc <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2914:	6a050513          	addi	a0,a0,1696 # 6fb0 <statistics+0xe98>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2968:	66c50513          	addi	a0,a0,1644 # 6fd0 <statistics+0xeb8>
  ...
  if(c != a + 1){
    ...
    29ca:	66a50513          	addi	a0,a0,1642 # 7030 <statistics+0xf18>
    ...
    29ec:	60850513          	addi	a0,a0,1544 # 6ff0 <statistics+0xed8>
    ...
    2a08:	60c50513          	addi	a0,a0,1548 # 7010 <statistics+0xef8>
...
0000000000002a44 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b52:	50250513          	addi	a0,a0,1282 # 7050 <statistics+0xf38>
    ...
    2b6e:	52e50513          	addi	a0,a0,1326 # 7098 <statistics+0xf80>
    ...
    2b8e:	52e50513          	addi	a0,a0,1326 # 70b8 <statistics+0xfa0>
    ...
    2bae:	54e50513          	addi	a0,a0,1358 # 70f8 <statistics+0xfe0>
    ...
    2bca:	56250513          	addi	a0,a0,1378 # 7128 <statistics+0x1010>
    ...
    2bea:	57a50513          	addi	a0,a0,1402 # 7160 <statistics+0x1048>
...
0000000000002c00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c24:	56850513          	addi	a0,a0,1384 # 7188 <statistics+0x1070>
    2c28:	00003097          	auipc	ra,0x3
    2c2c:	016080e7          	jalr	22(ra) # 5c3e <open>
    2c30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c32:	00004517          	auipc	a0,0x4
    2c36:	55650513          	addi	a0,a0,1366 # 7188 <statistics+0x1070>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c8a:	50a50513          	addi	a0,a0,1290 # 7190 <statistics+0x1078>
    ...
    2ca6:	50650513          	addi	a0,a0,1286 # 71a8 <statistics+0x1090>
    ...
    2cc2:	eca50513          	addi	a0,a0,-310 # 6b88 <statistics+0xa70>
...
0000000000002cd8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cec:	4d850513          	addi	a0,a0,1240 # 71c0 <statistics+0x10a8>
  ...
  close(fd);
    ...
    2d34:	d6850513          	addi	a0,a0,-664 # 6a98 <statistics+0x980>
...
0000000000002d4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d82:	10a50513          	addi	a0,a0,266 # 6e88 <statistics+0xd70>
  ...
  if(pid == 0){
    ...
    2dd8:	0b450513          	addi	a0,a0,180 # 6e88 <statistics+0xd70>
  ...
  if(pid == 0){
    ...
    2e38:	05450513          	addi	a0,a0,84 # 6e88 <statistics+0xd70>
...
0000000000002f6a <execout>:
{
  ...
  exit(0);
    ...
    2fac:	ee050513          	addi	a0,a0,-288 # 6e88 <statistics+0xd70>
    ...
    3000:	1fc50513          	addi	a0,a0,508 # 61f8 <statistics+0xe0>
    3004:	faa43c23          	sd	a0,-72(s0)
    3008:	00003797          	auipc	a5,0x3
    300c:	26078793          	addi	a5,a5,608 # 6268 <statistics+0x150>
...
000000000000302e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    303e:	35e50513          	addi	a0,a0,862 # 7398 <statistics+0x1280>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3050:	1a450513          	addi	a0,a0,420 # 71f0 <statistics+0x10d8>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3066:	1e650513          	addi	a0,a0,486 # 7248 <statistics+0x1130>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3084:	24050513          	addi	a0,a0,576 # 72c0 <statistics+0x11a8>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30a0:	29450513          	addi	a0,a0,660 # 7330 <statistics+0x1218>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30b2:	2da50513          	addi	a0,a0,730 # 7388 <statistics+0x1270>
  ...
  unlink("12345678901234");
    ...
    3130:	09c50513          	addi	a0,a0,156 # 71c8 <statistics+0x10b0>
    ...
    314c:	0c850513          	addi	a0,a0,200 # 7210 <statistics+0x10f8>
    ...
    3168:	11450513          	addi	a0,a0,276 # 7278 <statistics+0x1160>
    ...
    3184:	17050513          	addi	a0,a0,368 # 72f0 <statistics+0x11d8>
    ...
    31a0:	1b450513          	addi	a0,a0,436 # 7350 <statistics+0x1238>
    ...
    31bc:	1f050513          	addi	a0,a0,496 # 73a8 <statistics+0x1290>
...
00000000000031d2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    320c:	1d850513          	addi	a0,a0,472 # 73e0 <statistics+0x12c8>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    323c:	1b850513          	addi	a0,a0,440 # 73f0 <statistics+0x12d8>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32ca:	11a50513          	addi	a0,a0,282 # 73e0 <statistics+0x12c8>
  ...
  unlink("diskfulldir");
    ...
    32de:	10650513          	addi	a0,a0,262 # 73e0 <statistics+0x12c8>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    3416:	ffe50513          	addi	a0,a0,-2 # 7410 <statistics+0x12f8>
...
0000000000003424 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3434:	01050513          	addi	a0,a0,16 # 7440 <statistics+0x1328>
  ...
  if(chdir("iputdir") < 0){
    ...
    3448:	ffc50513          	addi	a0,a0,-4 # 7440 <statistics+0x1328>
  ...
  if(unlink("../iputdir") < 0){
    ...
    345c:	02850513          	addi	a0,a0,40 # 7480 <statistics+0x1368>
  ...
  if(chdir("/") < 0){
    ...
    3470:	04450513          	addi	a0,a0,68 # 74b0 <statistics+0x1398>
    ...
    3490:	fbc50513          	addi	a0,a0,-68 # 7448 <statistics+0x1330>
    ...
    34ac:	fb850513          	addi	a0,a0,-72 # 7460 <statistics+0x1348>
    ...
    34c8:	fcc50513          	addi	a0,a0,-52 # 7490 <statistics+0x1378>
    ...
    34e4:	fd850513          	addi	a0,a0,-40 # 74b8 <statistics+0x13a0>
...
00000000000034fa <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3518:	f2c50513          	addi	a0,a0,-212 # 7440 <statistics+0x1328>
    ...
    352c:	f1850513          	addi	a0,a0,-232 # 7440 <statistics+0x1328>
    ...
    3540:	f4450513          	addi	a0,a0,-188 # 7480 <statistics+0x1368>
    ...
    3560:	52450513          	addi	a0,a0,1316 # 6a80 <statistics+0x968>
    ...
    357c:	ed050513          	addi	a0,a0,-304 # 7448 <statistics+0x1330>
    ...
    3598:	f3c50513          	addi	a0,a0,-196 # 74d0 <statistics+0x13b8>
    ...
    35b4:	ee050513          	addi	a0,a0,-288 # 7490 <statistics+0x1378>
...
00000000000035e2 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35f2:	efa50513          	addi	a0,a0,-262 # 74e8 <statistics+0x13d0>
  ...
  if(chdir("dir0") < 0){
    ...
    3606:	ee650513          	addi	a0,a0,-282 # 74e8 <statistics+0x13d0>
  ...
  if(chdir("..") < 0){
    ...
    361a:	ef250513          	addi	a0,a0,-270 # 7508 <statistics+0x13f0>
  ...
  if(unlink("dir0") < 0){
    ...
    362e:	ebe50513          	addi	a0,a0,-322 # 74e8 <statistics+0x13d0>
    ...
    364e:	dfe50513          	addi	a0,a0,-514 # 7448 <statistics+0x1330>
    ...
    366a:	e8a50513          	addi	a0,a0,-374 # 74f0 <statistics+0x13d8>
    ...
    3686:	e8e50513          	addi	a0,a0,-370 # 7510 <statistics+0x13f8>
    ...
    36a2:	e8a50513          	addi	a0,a0,-374 # 7528 <statistics+0x1410>
...
00000000000036b8 <subdir>:
{
  ...
  unlink("ff");
    ...
    36ca:	faa50513          	addi	a0,a0,-86 # 7670 <statistics+0x1558>
    36ce:	00002097          	auipc	ra,0x2
    36d2:	580080e7          	jalr	1408(ra) # 5c4e <unlink>
  if(mkdir("dd") != 0){
    36d6:	00004517          	auipc	a0,0x4
    36da:	e6a50513          	addi	a0,a0,-406 # 7540 <statistics+0x1428>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36f2:	e7250513          	addi	a0,a0,-398 # 7560 <statistics+0x1448>
  ...
  write(fd, "ff", 2);
    ...
    370a:	f6a58593          	addi	a1,a1,-150 # 7670 <statistics+0x1558>
  ...
  if(unlink("dd") >= 0){
    ...
    3724:	e2050513          	addi	a0,a0,-480 # 7540 <statistics+0x1428>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3738:	e8450513          	addi	a0,a0,-380 # 75b8 <statistics+0x14a0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3750:	e9450513          	addi	a0,a0,-364 # 75e0 <statistics+0x14c8>
  ...
  write(fd, "FF", 2);
    ...
    3768:	eac58593          	addi	a1,a1,-340 # 7610 <statistics+0x14f8>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3784:	e9850513          	addi	a0,a0,-360 # 7618 <statistics+0x1500>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37cc:	ea058593          	addi	a1,a1,-352 # 7668 <statistics+0x1550>
    37d0:	00004517          	auipc	a0,0x4
    37d4:	e1050513          	addi	a0,a0,-496 # 75e0 <statistics+0x14c8>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37e8:	dfc50513          	addi	a0,a0,-516 # 75e0 <statistics+0x14c8>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37fe:	de650513          	addi	a0,a0,-538 # 75e0 <statistics+0x14c8>
  ...
  if(chdir("dd") != 0){
    ...
    3812:	d3250513          	addi	a0,a0,-718 # 7540 <statistics+0x1428>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3826:	ede50513          	addi	a0,a0,-290 # 7700 <statistics+0x15e8>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    383a:	efa50513          	addi	a0,a0,-262 # 7730 <statistics+0x1618>
  ...
  if(chdir("./..") != 0){
    ...
    384e:	f1650513          	addi	a0,a0,-234 # 7760 <statistics+0x1648>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3864:	e0850513          	addi	a0,a0,-504 # 7668 <statistics+0x1550>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    389e:	d4650513          	addi	a0,a0,-698 # 75e0 <statistics+0x14c8>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b6:	f3e50513          	addi	a0,a0,-194 # 77f0 <statistics+0x16d8>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ce:	f5650513          	addi	a0,a0,-170 # 7820 <statistics+0x1708>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38e6:	c5e50513          	addi	a0,a0,-930 # 7540 <statistics+0x1428>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38fc:	c4850513          	addi	a0,a0,-952 # 7540 <statistics+0x1428>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3912:	c3250513          	addi	a0,a0,-974 # 7540 <statistics+0x1428>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3926:	f8e58593          	addi	a1,a1,-114 # 78b0 <statistics+0x1798>
    392a:	00004517          	auipc	a0,0x4
    392e:	ec650513          	addi	a0,a0,-314 # 77f0 <statistics+0x16d8>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3942:	f7258593          	addi	a1,a1,-142 # 78b0 <statistics+0x1798>
    3946:	00004517          	auipc	a0,0x4
    394a:	eda50513          	addi	a0,a0,-294 # 7820 <statistics+0x1708>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    395e:	d0e58593          	addi	a1,a1,-754 # 7668 <statistics+0x1550>
    3962:	00004517          	auipc	a0,0x4
    3966:	bfe50513          	addi	a0,a0,-1026 # 7560 <statistics+0x1448>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    397a:	e7a50513          	addi	a0,a0,-390 # 77f0 <statistics+0x16d8>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    398e:	e9650513          	addi	a0,a0,-362 # 7820 <statistics+0x1708>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39a2:	cca50513          	addi	a0,a0,-822 # 7668 <statistics+0x1550>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39b6:	e6e50513          	addi	a0,a0,-402 # 7820 <statistics+0x1708>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ca:	e2a50513          	addi	a0,a0,-470 # 77f0 <statistics+0x16d8>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39de:	b8650513          	addi	a0,a0,-1146 # 7560 <statistics+0x1448>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39f2:	01250513          	addi	a0,a0,18 # 7a00 <statistics+0x18e8>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a06:	c6650513          	addi	a0,a0,-922 # 7668 <statistics+0x1550>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a1a:	b4a50513          	addi	a0,a0,-1206 # 7560 <statistics+0x1448>
  ...
  if(unlink("dd") == 0){
    ...
    3a2e:	b1650513          	addi	a0,a0,-1258 # 7540 <statistics+0x1428>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a42:	03250513          	addi	a0,a0,50 # 7a70 <statistics+0x1958>
  ...
  if(unlink("dd") < 0){
    ...
    3a56:	aee50513          	addi	a0,a0,-1298 # 7540 <statistics+0x1428>
    ...
    3a78:	ad450513          	addi	a0,a0,-1324 # 7548 <statistics+0x1430>
    ...
    3a94:	ad850513          	addi	a0,a0,-1320 # 7568 <statistics+0x1450>
    ...
    3ab0:	adc50513          	addi	a0,a0,-1316 # 7588 <statistics+0x1470>
    ...
    3acc:	af850513          	addi	a0,a0,-1288 # 75c0 <statistics+0x14a8>
    ...
    3ae8:	b0c50513          	addi	a0,a0,-1268 # 75f0 <statistics+0x14d8>
    ...
    3b04:	b2850513          	addi	a0,a0,-1240 # 7628 <statistics+0x1510>
    ...
    3b20:	b2c50513          	addi	a0,a0,-1236 # 7648 <statistics+0x1530>
    ...
    3b3c:	b4050513          	addi	a0,a0,-1216 # 7678 <statistics+0x1560>
    ...
    3b58:	b4c50513          	addi	a0,a0,-1204 # 76a0 <statistics+0x1588>
    ...
    3b74:	b5050513          	addi	a0,a0,-1200 # 76c0 <statistics+0x15a8>
    ...
    3b90:	b5c50513          	addi	a0,a0,-1188 # 76e8 <statistics+0x15d0>
    ...
    3bac:	b6850513          	addi	a0,a0,-1176 # 7710 <statistics+0x15f8>
    ...
    3bc8:	b7c50513          	addi	a0,a0,-1156 # 7740 <statistics+0x1628>
    ...
    3be4:	b8850513          	addi	a0,a0,-1144 # 7768 <statistics+0x1650>
    ...
    3c00:	b8450513          	addi	a0,a0,-1148 # 7780 <statistics+0x1668>
    ...
    3c1c:	b8850513          	addi	a0,a0,-1144 # 77a0 <statistics+0x1688>
    ...
    3c38:	b8c50513          	addi	a0,a0,-1140 # 77c0 <statistics+0x16a8>
    ...
    3c54:	bb050513          	addi	a0,a0,-1104 # 7800 <statistics+0x16e8>
    ...
    3c70:	bc450513          	addi	a0,a0,-1084 # 7830 <statistics+0x1718>
    ...
    3c8c:	bc850513          	addi	a0,a0,-1080 # 7850 <statistics+0x1738>
    ...
    3ca8:	bcc50513          	addi	a0,a0,-1076 # 7870 <statistics+0x1758>
    ...
    3cc4:	bd050513          	addi	a0,a0,-1072 # 7890 <statistics+0x1778>
    ...
    3ce0:	be450513          	addi	a0,a0,-1052 # 78c0 <statistics+0x17a8>
    ...
    3cfc:	bf050513          	addi	a0,a0,-1040 # 78e8 <statistics+0x17d0>
    ...
    3d18:	bfc50513          	addi	a0,a0,-1028 # 7910 <statistics+0x17f8>
    ...
    3d34:	c0850513          	addi	a0,a0,-1016 # 7938 <statistics+0x1820>
    ...
    3d50:	c0c50513          	addi	a0,a0,-1012 # 7958 <statistics+0x1840>
    ...
    3d6c:	c1050513          	addi	a0,a0,-1008 # 7978 <statistics+0x1860>
    ...
    3d88:	c1c50513          	addi	a0,a0,-996 # 79a0 <statistics+0x1888>
    ...
    3da4:	c2050513          	addi	a0,a0,-992 # 79c0 <statistics+0x18a8>
    ...
    3dc0:	c2450513          	addi	a0,a0,-988 # 79e0 <statistics+0x18c8>
    ...
    3ddc:	c3050513          	addi	a0,a0,-976 # 7a08 <statistics+0x18f0>
    ...
    3df8:	8ac50513          	addi	a0,a0,-1876 # 76a0 <statistics+0x1588>
    ...
    3e14:	c1850513          	addi	a0,a0,-1000 # 7a28 <statistics+0x1910>
    ...
    3e30:	c1c50513          	addi	a0,a0,-996 # 7a48 <statistics+0x1930>
    ...
    3e4c:	c3050513          	addi	a0,a0,-976 # 7a78 <statistics+0x1960>
    ...
    3e68:	c3450513          	addi	a0,a0,-972 # 7a98 <statistics+0x1980>
...
0000000000003e7e <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e8e:	c2650513          	addi	a0,a0,-986 # 7ab0 <statistics+0x1998>
  ...
  if(chdir("dots") != 0){
    ...
    3ea0:	c1450513          	addi	a0,a0,-1004 # 7ab0 <statistics+0x1998>
  ...
  if(unlink(".") == 0){
    ...
    3eb2:	a3250513          	addi	a0,a0,-1486 # 68e0 <statistics+0x7c8>
  ...
  if(unlink("..") == 0){
    ...
    3ec4:	64850513          	addi	a0,a0,1608 # 7508 <statistics+0x13f0>
  ...
  if(chdir("/") != 0){
    ...
    3ed6:	5de50513          	addi	a0,a0,1502 # 74b0 <statistics+0x1398>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ee8:	c3450513          	addi	a0,a0,-972 # 7b18 <statistics+0x1a00>
  ...
  if(unlink("dots/..") == 0){
    ...
    3efa:	c4a50513          	addi	a0,a0,-950 # 7b40 <statistics+0x1a28>
  ...
  if(unlink("dots") != 0){
    ...
    3f0c:	ba850513          	addi	a0,a0,-1112 # 7ab0 <statistics+0x1998>
    ...
    3f2a:	b9250513          	addi	a0,a0,-1134 # 7ab8 <statistics+0x19a0>
    ...
    3f46:	b8e50513          	addi	a0,a0,-1138 # 7ad0 <statistics+0x19b8>
    ...
    3f62:	b8a50513          	addi	a0,a0,-1142 # 7ae8 <statistics+0x19d0>
    ...
    3f7e:	b8650513          	addi	a0,a0,-1146 # 7b00 <statistics+0x19e8>
    ...
    3f9a:	52250513          	addi	a0,a0,1314 # 74b8 <statistics+0x13a0>
    ...
    3fb6:	b6e50513          	addi	a0,a0,-1170 # 7b20 <statistics+0x1a08>
    ...
    3fd2:	b7a50513          	addi	a0,a0,-1158 # 7b48 <statistics+0x1a30>
    ...
    3fee:	b7e50513          	addi	a0,a0,-1154 # 7b68 <statistics+0x1a50>
...
0000000000004004 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    401a:	b7250513          	addi	a0,a0,-1166 # 7b88 <statistics+0x1a70>
  ...
  if(chdir("dirfile") == 0){
    ...
    4036:	b5650513          	addi	a0,a0,-1194 # 7b88 <statistics+0x1a70>
  ...
  fd = open("dirfile/xx", 0);
    ...
    404a:	b8a50513          	addi	a0,a0,-1142 # 7bd0 <statistics+0x1ab8>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4062:	b7250513          	addi	a0,a0,-1166 # 7bd0 <statistics+0x1ab8>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4076:	b5e50513          	addi	a0,a0,-1186 # 7bd0 <statistics+0x1ab8>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    408a:	b4a50513          	addi	a0,a0,-1206 # 7bd0 <statistics+0x1ab8>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    409e:	b3658593          	addi	a1,a1,-1226 # 7bd0 <statistics+0x1ab8>
    40a2:	00002517          	auipc	a0,0x2
    40a6:	32e50513          	addi	a0,a0,814 # 63d0 <statistics+0x2b8>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ba:	ad250513          	addi	a0,a0,-1326 # 7b88 <statistics+0x1a70>
  ...
  fd = open(".", O_RDWR);
    ...
    40d0:	81450513          	addi	a0,a0,-2028 # 68e0 <statistics+0x7c8>
  ...
  fd = open(".", 0);
    ...
    40e6:	7fe50513          	addi	a0,a0,2046 # 68e0 <statistics+0x7c8>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40fa:	17258593          	addi	a1,a1,370 # 6268 <statistics+0x150>
  ...
  close(fd);
    ...
    4126:	a6e50513          	addi	a0,a0,-1426 # 7b90 <statistics+0x1a78>
    ...
    4142:	a7250513          	addi	a0,a0,-1422 # 7bb0 <statistics+0x1a98>
    ...
    415e:	a8650513          	addi	a0,a0,-1402 # 7be0 <statistics+0x1ac8>
    ...
    417a:	a6a50513          	addi	a0,a0,-1430 # 7be0 <statistics+0x1ac8>
    ...
    4196:	a7650513          	addi	a0,a0,-1418 # 7c08 <statistics+0x1af0>
    ...
    41b2:	a8250513          	addi	a0,a0,-1406 # 7c30 <statistics+0x1b18>
    ...
    41ce:	a8e50513          	addi	a0,a0,-1394 # 7c58 <statistics+0x1b40>
    ...
    41ea:	a9a50513          	addi	a0,a0,-1382 # 7c80 <statistics+0x1b68>
    ...
    4206:	a9e50513          	addi	a0,a0,-1378 # 7ca0 <statistics+0x1b88>
    ...
    4222:	aaa50513          	addi	a0,a0,-1366 # 7cc8 <statistics+0x1bb0>
...
0000000000004238 <iref>:
{
    ...
    4256:	a8ea0a13          	addi	s4,s4,-1394 # 7ce0 <statistics+0x1bc8>
    mkdir("");
    425a:	00003497          	auipc	s1,0x3
    425e:	58e48493          	addi	s1,s1,1422 # 77e8 <statistics+0x16d0>
    link("README", "");
    4262:	00002a97          	auipc	s5,0x2
    4266:	16ea8a93          	addi	s5,s5,366 # 63d0 <statistics+0x2b8>
    fd = open("xx", O_CREATE);
    426a:	00004997          	auipc	s3,0x4
    426e:	96e98993          	addi	s3,s3,-1682 # 7bd8 <statistics+0x1ac0>
    4272:	a891                	j	42c6 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4274:	85da                	mv	a1,s6
    4276:	00004517          	auipc	a0,0x4
    427a:	a7250513          	addi	a0,a0,-1422 # 7ce8 <statistics+0x1bd0>
    ...
    4296:	a6e50513          	addi	a0,a0,-1426 # 7d00 <statistics+0x1be8>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    432a:	1e298993          	addi	s3,s3,482 # 7508 <statistics+0x13f0>
    unlink("irefd");
    432e:	00004917          	auipc	s2,0x4
    4332:	9b290913          	addi	s2,s2,-1614 # 7ce0 <statistics+0x1bc8>
    chdir("..");
    4336:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4352:	16250513          	addi	a0,a0,354 # 74b0 <statistics+0x1398>
...
0000000000004372 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4382:	99a50513          	addi	a0,a0,-1638 # 7d18 <statistics+0x1c00>
  ...
  if(pid == 0){
    ...
    43a6:	97650513          	addi	a0,a0,-1674 # 7d18 <statistics+0x1c00>
    ...
    43bc:	98050513          	addi	a0,a0,-1664 # 7d38 <statistics+0x1c20>
    ...
    43d8:	94c50513          	addi	a0,a0,-1716 # 7d20 <statistics+0x1c08>
    ...
    43f4:	69050513          	addi	a0,a0,1680 # 6a80 <statistics+0x968>
  ...
  if(unlink("oidir") != 0){
    ...
    4422:	8fa50513          	addi	a0,a0,-1798 # 7d18 <statistics+0x1c00>
    ...
    4436:	83e50513          	addi	a0,a0,-1986 # 6c70 <statistics+0xb58>
...
0000000000004464 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4474:	8f050513          	addi	a0,a0,-1808 # 7d60 <statistics+0x1c48>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44a0:	8c450513          	addi	a0,a0,-1852 # 7d60 <statistics+0x1c48>
  ...
  sleep(10); // one second
    ...
    44d8:	76c50513          	addi	a0,a0,1900 # 6c40 <statistics+0xb28>
    ...
    44f2:	87248493          	addi	s1,s1,-1934 # 7d60 <statistics+0x1c48>
    44f6:	4581                	li	a1,0
    44f8:	8526                	mv	a0,s1
...
0000000000004534 <killstatus>:
{
  ...
  exit(0);
    ...
    459a:	4ea50513          	addi	a0,a0,1258 # 6a80 <statistics+0x968>
    ...
    45c0:	7b450513          	addi	a0,a0,1972 # 7d70 <statistics+0x1c58>
...
00000000000045d6 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4600:	64450513          	addi	a0,a0,1604 # 6c40 <statistics+0xb28>
  ...
  if(pid2 == 0)
    ...
    462e:	45650513          	addi	a0,a0,1110 # 6a80 <statistics+0x968>
  ...
  if(pid3 == 0){
    ...
    4672:	bfa58593          	addi	a1,a1,-1030 # 6268 <statistics+0x150>
    ...
    469c:	3e850513          	addi	a0,a0,1000 # 6a80 <statistics+0x968>
    ...
    46b8:	6dc50513          	addi	a0,a0,1756 # 7d90 <statistics+0x1c78>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46f4:	6b850513          	addi	a0,a0,1720 # 7da8 <statistics+0x1c90>
  ...
  printf("kill... ");
    ...
    4720:	6a450513          	addi	a0,a0,1700 # 7dc0 <statistics+0x1ca8>
  ...
  printf("wait... ");
    ...
    474e:	68650513          	addi	a0,a0,1670 # 7dd0 <statistics+0x1cb8>
...
000000000000477a <reparent>:
{
  ...
  exit(0);
    ...
    47ce:	2b650513          	addi	a0,a0,694 # 6a80 <statistics+0x968>
    ...
    47ea:	42250513          	addi	a0,a0,1058 # 6c08 <statistics+0xaf0>
...
000000000000482a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4860:	32c50513          	addi	a0,a0,812 # 6b88 <statistics+0xa70>
    ...
    4896:	9d658593          	addi	a1,a1,-1578 # 6268 <statistics+0x150>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    495a:	48a50513          	addi	a0,a0,1162 # 7de0 <statistics+0x1cc8>
    ...
    4976:	10e50513          	addi	a0,a0,270 # 6a80 <statistics+0x968>
    ...
    49c2:	44250513          	addi	a0,a0,1090 # 7e00 <statistics+0x1ce8>
...
00000000000049e2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a4a:	3ea50513          	addi	a0,a0,1002 # 7e30 <statistics+0x1d18>
...
0000000000004a88 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b1e:	34650513          	addi	a0,a0,838 # 7e60 <statistics+0x1d48>
    ...
    4b3a:	35250513          	addi	a0,a0,850 # 7e88 <statistics+0x1d70>
  ...
  fd = open("sharedfd", 0);
    ...
    4b7e:	2d650513          	addi	a0,a0,726 # 7e50 <statistics+0x1d38>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bbe:	2ee50513          	addi	a0,a0,750 # 7ea8 <statistics+0x1d90>
  ...
  unlink("sharedfd");
    ...
    4bfa:	25a50513          	addi	a0,a0,602 # 7e50 <statistics+0x1d38>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c20:	2b450513          	addi	a0,a0,692 # 7ed0 <statistics+0x1db8>
...
0000000000004c40 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c64:	54078793          	addi	a5,a5,1344 # 61a0 <statistics+0x88>
    4c68:	f6f43823          	sd	a5,-144(s0)
    4c6c:	00001797          	auipc	a5,0x1
    4c70:	53c78793          	addi	a5,a5,1340 # 61a8 <statistics+0x90>
    4c74:	f6f43c23          	sd	a5,-136(s0)
    4c78:	00001797          	auipc	a5,0x1
    4c7c:	53878793          	addi	a5,a5,1336 # 61b0 <statistics+0x98>
    4c80:	f8f43023          	sd	a5,-128(s0)
    4c84:	00001797          	auipc	a5,0x1
    4c88:	53478793          	addi	a5,a5,1332 # 61b8 <statistics+0xa0>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d00:	18c50513          	addi	a0,a0,396 # 6e88 <statistics+0xd70>
    ...
    4d7a:	17250513          	addi	a0,a0,370 # 7ee8 <statistics+0x1dd0>
    ...
    4d94:	16850513          	addi	a0,a0,360 # 7ef8 <statistics+0x1de0>
    ...
    4db8:	15c50513          	addi	a0,a0,348 # 7f10 <statistics+0x1df8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e48:	0dc50513          	addi	a0,a0,220 # 7f20 <statistics+0x1e08>
...
0000000000004e7c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eaa:	092b8b93          	addi	s7,s7,146 # 7f38 <statistics+0x1e20>
  for(i = 0; i < N; i++){
    ...
    4eec:	05850513          	addi	a0,a0,88 # 7f40 <statistics+0x1e28>
    ...
    4f0a:	03250513          	addi	a0,a0,50 # 7f38 <statistics+0x1e20>
  ...
  fd = open(".", 0);
    ...
    4f42:	9a250513          	addi	a0,a0,-1630 # 68e0 <statistics+0x7c8>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f68:	ffc50513          	addi	a0,a0,-4 # 7f60 <statistics+0x1e48>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fd8:	fac50513          	addi	a0,a0,-84 # 7f80 <statistics+0x1e68>
  ...
  for(i = 0; i < N; i++){
    ...
    5010:	f9c50513          	addi	a0,a0,-100 # 7fa8 <statistics+0x1e90>
    ...
    502c:	a5850513          	addi	a0,a0,-1448 # 6a80 <statistics+0x968>
...
00000000000051d6 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    525e:	d8650513          	addi	a0,a0,-634 # 7fe0 <statistics+0x1ec8>
  ...
  for(i = 0; ; i++){
    ...
    52c2:	d3250513          	addi	a0,a0,-718 # 7ff0 <statistics+0x1ed8>
    ...
    52de:	d3650513          	addi	a0,a0,-714 # 8010 <statistics+0x1ef8>
    ...
    52fa:	d3a50513          	addi	a0,a0,-710 # 8030 <statistics+0x1f18>
    ...
    5316:	d3e50513          	addi	a0,a0,-706 # 8050 <statistics+0x1f38>
    ...
    5332:	d4250513          	addi	a0,a0,-702 # 8070 <statistics+0x1f58>
    ...
    534e:	d3e50513          	addi	a0,a0,-706 # 8088 <statistics+0x1f70>
  ...
  unlink("bigfile.dat");
    ...
    537c:	c6850513          	addi	a0,a0,-920 # 7fe0 <statistics+0x1ec8>
    ...
    53a0:	d0c50513          	addi	a0,a0,-756 # 80a8 <statistics+0x1f90>
...
00000000000053b6 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53d8:	cf450513          	addi	a0,a0,-780 # 80c8 <statistics+0x1fb0>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53f8:	ce4c8c93          	addi	s9,s9,-796 # 80d8 <statistics+0x1fc0>
    int total = 0;
    53fc:	4d81                	li	s11,0
    ...
    5472:	c7a50513          	addi	a0,a0,-902 # 80e8 <statistics+0x1fd0>
  ...
  printf("fsfull test finished\n");
    ...
    54e8:	c2450513          	addi	a0,a0,-988 # 8108 <statistics+0x1ff0>
    ...
    5538:	bc450513          	addi	a0,a0,-1084 # 80f8 <statistics+0x1fe0>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    556a:	bba50513          	addi	a0,a0,-1094 # 8120 <statistics+0x2008>
  ...
  if(pid == 0) {
    ...
    559a:	bb250513          	addi	a0,a0,-1102 # 8148 <statistics+0x2030>
    ...
    55be:	b7650513          	addi	a0,a0,-1162 # 8130 <statistics+0x2018>
    ...
    55e6:	b6e50513          	addi	a0,a0,-1170 # 8150 <statistics+0x2038>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    563e:	b1e50513          	addi	a0,a0,-1250 # 8158 <statistics+0x2040>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56a0:	bcc90913          	addi	s2,s2,-1076 # 6268 <statistics+0x150>
      uint64 a = (uint64) sbrk(4096);
    ...
    56d4:	ae050513          	addi	a0,a0,-1312 # 81b0 <statistics+0x2098>
    ...
    56ee:	a8650513          	addi	a0,a0,-1402 # 8170 <statistics+0x2058>
    ...
    5708:	a8c50513          	addi	a0,a0,-1396 # 8190 <statistics+0x2078>
  ...
  while(1){
    ...
    5756:	a7e50513          	addi	a0,a0,-1410 # 81d0 <statistics+0x20b8>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57b8:	a3cb8b93          	addi	s7,s7,-1476 # 81f0 <statistics+0x20d8>
    int free0 = countfree();
    int free1 = 0;
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58d4:	98858593          	addi	a1,a1,-1656 # 8258 <statistics+0x2140>
    ...
    58ea:	9ca58593          	addi	a1,a1,-1590 # 82b0 <statistics+0x2198>
    ...
    5900:	9ac58593          	addi	a1,a1,-1620 # 82a8 <statistics+0x2190>
  ...
  int continuous = 0;
    ...
    592c:	93850513          	addi	a0,a0,-1736 # 8260 <statistics+0x2148>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5958:	93c50513          	addi	a0,a0,-1732 # 8290 <statistics+0x2178>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5ce6:	93e50513          	addi	a0,a0,-1730 # 8620 <digits>
    5cea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5db2:	872b8b93          	addi	s7,s7,-1934 # 8620 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ef2:	72a90913          	addi	s2,s2,1834 # 8618 <statistics+0x2500>
        while(*s != 0){
...
{
    6118:	7179                	addi	sp,sp,-48
    611a:	f406                	sd	ra,40(sp)
    611c:	f022                	sd	s0,32(sp)
    611e:	ec26                	sd	s1,24(sp)
    6120:	e84a                	sd	s2,16(sp)
    6122:	e44e                	sd	s3,8(sp)
    6124:	e052                	sd	s4,0(sp)
    6126:	1800                	addi	s0,sp,48
    6128:	8a2a                	mv	s4,a0
    612a:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    612c:	4581                	li	a1,0
    612e:	00002517          	auipc	a0,0x2
    6132:	50a50513          	addi	a0,a0,1290 # 8638 <digits+0x18>
    6136:	00000097          	auipc	ra,0x0
    613a:	b08080e7          	jalr	-1272(ra) # 5c3e <open>
  if(fd < 0) {
    613e:	04054263          	bltz	a0,6182 <statistics+0x6a>
    6142:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    6144:	4481                	li	s1,0
    6146:	03205063          	blez	s2,6166 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    614a:	4099063b          	subw	a2,s2,s1
    614e:	009a05b3          	add	a1,s4,s1
    6152:	854e                	mv	a0,s3
    6154:	00000097          	auipc	ra,0x0
    6158:	ac2080e7          	jalr	-1342(ra) # 5c16 <read>
    615c:	00054563          	bltz	a0,6166 <statistics+0x4e>
      break;
    }
    i += n;
    6160:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    6162:	ff24c4e3          	blt	s1,s2,614a <statistics+0x32>
  }
  close(fd);
    6166:	854e                	mv	a0,s3
    6168:	00000097          	auipc	ra,0x0
    616c:	abe080e7          	jalr	-1346(ra) # 5c26 <close>
  return i;
}
    6170:	8526                	mv	a0,s1
    6172:	70a2                	ld	ra,40(sp)
    6174:	7402                	ld	s0,32(sp)
    6176:	64e2                	ld	s1,24(sp)
    6178:	6942                	ld	s2,16(sp)
    617a:	69a2                	ld	s3,8(sp)
    617c:	6a02                	ld	s4,0(sp)
    617e:	6145                	addi	sp,sp,48
    6180:	8082                	ret
      fprintf(2, "stats: open failed\n");
    6182:	00002597          	auipc	a1,0x2
    6186:	4c658593          	addi	a1,a1,1222 # 8648 <digits+0x28>
    618a:	4509                	li	a0,2
    618c:	00000097          	auipc	ra,0x0
    6190:	dbc080e7          	jalr	-580(ra) # 5f48 <fprintf>
      exit(1);
    6194:	4505                	li	a0,1
    6196:	00000097          	auipc	ra,0x0
    619a:	a68080e7          	jalr	-1432(ra) # 5bfe <exit>
