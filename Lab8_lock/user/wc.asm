...
wc(int fd, char *name)
{
  ...
  3c:	998a0a13          	addi	s4,s4,-1640 # 9d0 <statistics+0x90>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	93250513          	addi	a0,a0,-1742 # 9e8 <statistics+0xa8>
  ...
  e8:	8f450513          	addi	a0,a0,-1804 # 9d8 <statistics+0x98>
...
main(int argc, char *argv[])
{
 ...
 162:	89a58593          	addi	a1,a1,-1894 # 9f8 <statistics+0xb8>
 166:	4501                	li	a0,0
 ...
 180:	88450513          	addi	a0,a0,-1916 # a00 <statistics+0xc0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50e:	51650513          	addi	a0,a0,1302 # a20 <digits>
 512:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5da:	44ab8b93          	addi	s7,s7,1098 # a20 <digits>
 ...
 71a:	30290913          	addi	s2,s2,770 # a18 <statistics+0xd8>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 95a:	0e250513          	addi	a0,a0,226 # a38 <digits+0x18>
 95e:	00000097          	auipc	ra,0x0
 962:	b08080e7          	jalr	-1272(ra) # 466 <open>
  if(fd < 0) {
 966:	04054263          	bltz	a0,9aa <statistics+0x6a>
 96a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 96c:	4481                	li	s1,0
 96e:	03205063          	blez	s2,98e <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 972:	4099063b          	subw	a2,s2,s1
 976:	009a05b3          	add	a1,s4,s1
 97a:	854e                	mv	a0,s3
 97c:	00000097          	auipc	ra,0x0
 980:	ac2080e7          	jalr	-1342(ra) # 43e <read>
 984:	00054563          	bltz	a0,98e <statistics+0x4e>
      break;
    }
    i += n;
 988:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 98a:	ff24c4e3          	blt	s1,s2,972 <statistics+0x32>
  }
  close(fd);
 98e:	854e                	mv	a0,s3
 990:	00000097          	auipc	ra,0x0
 994:	abe080e7          	jalr	-1346(ra) # 44e <close>
  return i;
}
 998:	8526                	mv	a0,s1
 ...
 9ae:	09e58593          	addi	a1,a1,158 # a48 <digits+0x28>
 9b2:	4509                	li	a0,2
 9b4:	00000097          	auipc	ra,0x0
 9b8:	dbc080e7          	jalr	-580(ra) # 770 <fprintf>
      exit(1);
 9bc:	4505                	li	a0,1
 9be:	00000097          	auipc	ra,0x0
 9c2:	a68080e7          	jalr	-1432(ra) # 426 <exit>
