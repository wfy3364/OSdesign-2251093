...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 46e:	3feb8b93          	addi	s7,s7,1022 # 868 <digits>
 ...
 5ae:	2b690913          	addi	s2,s2,694 # 860 <statistics+0x8c>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 7ee:	09650513          	addi	a0,a0,150 # 880 <digits+0x18>
 7f2:	00000097          	auipc	ra,0x0
 7f6:	b08080e7          	jalr	-1272(ra) # 2fa <open>
  if(fd < 0) {
 7fa:	04054263          	bltz	a0,83e <statistics+0x6a>
 7fe:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 800:	4481                	li	s1,0
 802:	03205063          	blez	s2,822 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 806:	4099063b          	subw	a2,s2,s1
 80a:	009a05b3          	add	a1,s4,s1
 80e:	854e                	mv	a0,s3
 810:	00000097          	auipc	ra,0x0
 814:	ac2080e7          	jalr	-1342(ra) # 2d2 <read>
 818:	00054563          	bltz	a0,822 <statistics+0x4e>
      break;
    }
    i += n;
 81c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 81e:	ff24c4e3          	blt	s1,s2,806 <statistics+0x32>
  }
  close(fd);
 822:	854e                	mv	a0,s3
 824:	00000097          	auipc	ra,0x0
 828:	abe080e7          	jalr	-1346(ra) # 2e2 <close>
  return i;
}
 82c:	8526                	mv	a0,s1
 82e:	70a2                	ld	ra,40(sp)
 830:	7402                	ld	s0,32(sp)
 832:	64e2                	ld	s1,24(sp)
 834:	6942                	ld	s2,16(sp)
 836:	69a2                	ld	s3,8(sp)
 838:	6a02                	ld	s4,0(sp)
 83a:	6145                	addi	sp,sp,48
 83c:	8082                	ret
      fprintf(2, "stats: open failed\n");
 83e:	00000597          	auipc	a1,0x0
 842:	05258593          	addi	a1,a1,82 # 890 <digits+0x28>
 846:	4509                	li	a0,2
 848:	00000097          	auipc	ra,0x0
 84c:	dbc080e7          	jalr	-580(ra) # 604 <fprintf>
      exit(1);
 850:	4505                	li	a0,1
 852:	00000097          	auipc	ra,0x0
 856:	a68080e7          	jalr	-1432(ra) # 2ba <exit>
